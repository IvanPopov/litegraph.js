...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(r, w, m) {
  r != Array.prototype && r != Object.prototype && (r[w] = m.value);
};
$jscomp.getGlobal = function(r) {
  return "undefined" != typeof window && window === r ? r : "undefined" != typeof global && null != global ? global : r;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(r, w, m, y) {
  if (w) {
    m = $jscomp.global;
    r = r.split(".");
    ...
    y = m[r];
    w = w(y);
    w != y && null != w && $jscomp.defineProperty(m, r, {configurable:!0, writable:!0, value:w});
  }
};
$jscomp.polyfill("Object.is", function(r) {
  return r ? r : function(r, m) {
    return r === m ? 0 !== r || 1 / r === 1 / m : r !== r && m !== m;
  };
}, "es6", "es3");
...
$jscomp.checkStringArgs = function(r, w, m) {
  if (null == r) {
...
$jscomp.polyfill("String.prototype.includes", function(r) {
  return r ? r : function(r, m) {
    return -1 !== $jscomp.checkStringArgs(this, r, "includes").indexOf(r, m || 0);
  };
}, "es6", "es3");
...
$jscomp.polyfill("Array.prototype.values", function(r) {
  return r ? r : function() {
    return $jscomp.iteratorFromArray(this, function(r, m) {
      return m;
    });
  };
}, "es8", "es3");
...
$jscomp.findInternal = function(r, w, m) {
  r instanceof String && (r = String(r));
  for (var y = r.length, l = 0; l < y; l++) {
    var x = r[l];
    if (w.call(m, x, l, r)) {
      return {i:l, v:x};
    }
...
$jscomp.polyfill("Array.prototype.findIndex", function(r) {
  return r ? r : function(r, m) {
    return $jscomp.findInternal(this, r, m).i;
  };
}, "es6", "es3");
(function(r) {
  function w(a, b) {
    ...
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(a)) {
      return a = a.substring(1).split(""), 3 == a.length && (a = [a[0], a[0], a[1], a[1], a[2], a[2]]), a = "0x" + a.join(""), "rgba(" + [a >> 16 & 255, a >> 8 & 255, a & 255].join() + ("," + b + ")");
    }
    throw Error("Bad Hex");
  }
  function m(a) {
  ...
  m.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], e = [], d = {}, f = {}, h = {}, k = 0, q = this._nodes.length; k < q; ++k) {
      ...
      if (!a || t.onExecute) {
        ...
        var u = 0;
        if (t.inputs) {
          for (var p = 0, n = t.inputs.length; p < n; p++) {
  ...
  m.prototype.arrange = function(a, b) {
    ...
    for (d = 0; d < e.length; ++d) {
      if (h = e[d]) {
        for (var k = 100, q = a + g.NODE_TITLE_HEIGHT, t = 0; t < h.length; ++t) {
          f = h[t], f.pos[0] = b == g.VERTICAL_LAYOUT ? q : c, f.pos[1] = b == g.VERTICAL_LAYOUT ? c : q, max_size_index = b == g.VERTICAL_LAYOUT ? 1 : 0, f.size[max_size_index] > k && (k = f.size[max_size_index]), node_size_index = b == g.VERTICAL_LAYOUT ? 0 : 1, q += f.size[node_size_index] + a + g.NODE_TITLE_HEIGHT;
        }
        c += k + a;
      }
    }
  ...
  r.LGraphCanvas = g.LGraphCanvas = n;
  ...
  n.link_type_colors = {"-1":g.EVENT_LINK_COLOR, number:"#AAA", node:"#DCA"};
  n.gradients = {};
        ...
        for (var h = 0; h < b.outputs.length; ++h) {
          ...
          if (!k.not_subgraph_input) {
            if (this.drawButton(d - 200, e + 2, 180, f - 2)) {
              ...
              t ? (a.add(t), this.block_click = !1, this.last_click_position = null, this.selectNodes([t]), this.node_dragged = t, this.dragging_canvas = !1, t.setProperty("name", k.name), t.setProperty("type", k.type), this.node_dragged.pos[0] = this.graph_mouse[0] - 5, this.node_dragged.pos[1] = this.graph_mouse[1] - 5, this.graph.afterChange()) : console.error("graph input node not found:", q);
            }
            c.fillStyle = "#9C9";
            c.beginPath();
  ...
  n.prototype.drawNode = function(a, b) {
    ...
    if (this.live_mode) {
      ...
      b.globalAlpha = f;
      this.render_shadows && !d ? (b.shadowColor = g.DEFAULT_SHADOW_COLOR, b.shadowOffsetX = 2 * this.ds.scale, b.shadowOffsetY = 2 * this.ds.scale, b.shadowBlur = 3 * this.ds.scale) : b.shadowColor = "transparent";
          ...
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              ...
              if (!1 !== p.visible || g.draw_invisible_connections) {
                ...
                b.fillStyle = null != p.link ? p.color_on || this.default_connection_color_byType[n] || this.default_connection_color.input_on : p.color_off || this.default_connection_color_byTypeOff[n] || this.default_connection_color_byType[n] || this.default_connection_color.input_off;
          ...
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (p = a.outputs[c], !1 !== p.visible || g.draw_invisible_connections) {
                ...
                this.default_connection_color.output_off, b.beginPath(), "array" == n && (x = g.GRID_SHAPE), t = !0, n === g.EVENT || x === g.BOX_SHAPE ? k ? b.rect(v[0] - 5 + 0.5, v[1] - 8 + 0.5, 10, 14) : b.rect(v[0] - 6 + 0.5, v[1] - 5 + 0.5, 14, 10) : x === g.ARROW_SHAPE ? (b.moveTo(v[0] + 8, v[1] + 0.5), b.lineTo(v[0] - 4, v[1] + 6 + 0.5), b.lineTo(v[0] - 4, v[1] - 6 + 0.5), b.closePath()) : x === g.GRID_SHAPE ? (b.rect(v[0] - 4, v[1] - 4, 2, 2), b.rect(v[0] - 1, v[1] - 4, 2, 2), b.rect(v[0] + 
                2, v[1] - 4, 2, 2), b.rect(v[0] - 4, v[1] - 1, 2, 2), b.rect(v[0] - 1, v[1] - 1, 2, 2), b.rect(v[0] + 2, v[1] - 1, 2, 2), b.rect(v[0] - 4, v[1] + 2, 2, 2), b.rect(v[0] - 1, v[1] + 2, 2, 2), b.rect(v[0] + 2, v[1] + 2, 2, 2), t = !1) : d ? b.rect(v[0] - 4, v[1] - 4, 8, 8) : b.arc(v[0], v[1], 4, 0, 2 * Math.PI), b.fill(), !d && t && b.stroke(), e && (n = null != p.label ? p.label : p.name)) {
                  b.fillStyle = g.NODE_TEXT_COLOR, k || p.dir == g.DOWN ? b.fillText(n, v[0], v[1] - 8) : b.fillText(n, v[0] - 10, v[1] + 5);
                }
              }
            }
          }
  ...
  n.prototype.drawNodeShape = function(a, b, c, e, d, f, h) {
    ...
    var k = 0.5 > this.ds.scale, q = a._shape || a.constructor.shape || g.ROUND_SHAPE, t = a.constructor.title_mode, u = !0;
    ...
    b.fill();
    !a.flags.collapsed && u && (b.shadowColor = "transparent", b.fillStyle = "rgba(0,0,0,0.2)", b.fillRect(0, -1, z[2], 2));
    b.shadowColor = "transparent";
        ...
        for (var h = 0; h < f.inputs.length; ++h) {
          ...
          if (k && null != k.link && (k = this.graph.links[k.link])) {
            ...
            if (null != q) {
              ...
              if (H(C, I)) {
                var n = q.outputs[t], x = f.inputs[h];
                n && x && (t = !1 === n.visible || !1 === x.visible, !t || g.draw_invisible_connections) && (q = n.dir || (q.horizontal ? g.DOWN : g.RIGHT), x = x.dir || (f.horizontal ? g.UP : g.LEFT), this.renderLink(a, u, p, k, !1, 0, t ? "red" : null, q, x), k && k._last_time && 1000 > b - k._last_time && (t = 2.0 - 0.002 * (b - k._last_time), n = a.globalAlpha, a.globalAlpha = n * t, this.renderLink(a, u, p, k, !0, t, "white", q, x), a.globalAlpha = n));
              }
            }
          }
        }
  ...
  n.prototype.renderLink = function(a, b, c, e, d, f, h, k, q, t) {
    ...
    for (var p = 0; p < t; p += 1) {
      ...
      if (this.links_render_mode == g.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + l, b[1] + v + x, c[0] + m, c[1] + r + x, c[0], c[1] + x);
      } else {
    ...
    0.6 <= this.ds.scale && this.highquality_render && q != g.CENTER && (this.render_connection_arrows && (p = this.computeConnectionPoint(b, c, 0.25, k, q), u = this.computeConnectionPoint(b, c, 0.26, k, q), e = this.computeConnectionPoint(b, c, 0.75, k, q), t = this.computeConnectionPoint(b, c, 0.76, k, q), this.render_curved_connections ? (u = -Math.atan2(u[0] - p[0], u[1] - p[1]), t = -Math.atan2(t[0] - e[0], t[1] - e[1])) : t = u = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(p[0], p[1]), 
    a.rotate(u), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(e[0], e[1]), a.rotate(t), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), this.render_link_center && (a.beginPath(), a.arc(d[0], d[1], 5, 0, 2 * Math.PI), a.fill()));
    if (f) {
  ...
  n.prototype.drawNodeWidgets = function(a, b, c, e) {
    ...
    for (var q = g.WIDGET_OUTLINE_COLOR, t = g.WIDGET_BGCOLOR, n = g.WIDGET_TEXT_COLOR, p = g.WIDGET_SECONDARY_TEXT_COLOR, x = 0; x < f.length; ++x) {
      var l = f[x], v = b;
      l.y && (v = l.y);
      l.last_y = v;
      c.strokeStyle = q;
      ...
      switch(l.type) {
        ...
        case "slider":
          c.fillStyle = t;
          c.fillRect(15, v, m - 30, h);
          var r = l.options.max - l.options.min, A = (l.value - l.options.min) / r;
          c.fillStyle = e == l ? "#89A" : "#678";
          c.fillRect(15, v, A * (m - 30), h);
          k && !l.disabled && c.strokeRect(15, v, m - 30, h);
          l.marker && (r = (l.marker - l.options.min) / r, c.fillStyle = "#AA9", c.fillRect(15 + r * (m - 30), v, 2, h));
        ...
        case "combo":
          ...
          3), m - 30 - 20, v + 0.7 * h) : (r = l.value, l.options.values && (A = l.options.values, A.constructor === Function && (A = A()), A && A.constructor !== Array && (r = A[l.value])), c.fillText(r, m - 30 - 20, v + 0.7 * h)));
          break;
        case "string":
        case "text":
          c.textAlign = "left";
  ...
  n.prototype.processNodeWidgets = function(a, b, c, e) {
    ...
    for (var f = b[0] - a.pos[0], h = b[1] - a.pos[1], k = a.size[0], q = this, n = this.getCanvasWindow(), u = 0; u < a.widgets.length; ++u) {
      var p = a.widgets[u];
      if (p && !p.disabled) {
        ...
        if (p == e || !(6 > f || f > x - 12 || h < p.last_y || h > p.last_y + l || void 0 === p.last_y)) {
          ...
          switch(p.type) {
            case "button":
              ...
              break;
            case "slider":
              n = Math.clamp((f - 15) / (x - 30), 0, 1);
              p.value = p.options.min + (p.options.max - p.options.min) * n;
              ...
              if (c.type == g.pointerevents_method + "move" && "number" == p.type) {
                ...
                if (c.type == g.pointerevents_method + "down") {
                  ...
                  if ("number" == p.type) {
                    ...
                    if (f) {
                      n = -1, this.last_mouseclick = 0, n = v.constructor === Object ? m.indexOf(String(p.value)) + f : m.indexOf(p.value) + f, n >= m.length && (n = m.length - 1), 0 > n && (n = 0), p.value = v.constructor === Array ? v[n] : n;
                    } else {
                      var r = v != m ? Object.values(v) : v;
  ...
  n.prototype.showConnectionMenu = function(a) {
    ...
    var t = new g.ContextMenu(a, {event:b.e, title:(d && "" != d.name ? d.name + (h ? " | " : "") : "") + (d && h ? h : ""), callback:function(a, g, k) {
      switch(a) {
        case "Add Node":
          n.onMenuAdd(null, null, k, t, function(a) {
  ...
  n.onShowPropertyEditor = function(a, b, c, e, d) {
    ...
    var t = e = -20;
    c && (e -= c.left, t -= c.top);
    event ? (k.style.left = event.clientX + e + "px", k.style.top = event.clientY + t + "px") : (k.style.left = 0.5 * b.width + e + "px", k.style.top = 0.5 * b.height + t + "px");
  ...
  n.prototype.showSearchBox = function(a, b) {
        ...
        if (f.onSearchBox) {
          ...
          e = function(a, c) {
            ...
            if (b.do_type_filter && !c.skipFilter) {
              ...
              if (u && e && g.registered_slot_out_types[e] && g.registered_slot_out_types[e].nodes && (e = g.registered_slot_out_types[e].nodes.includes(a), !1 === e)) {
                return !1;
              }
            }
            return !0;
          ...
          if (b.do_type_filter && f.search_box) {
            var t = f.search_box.querySelector(".slot_in_type_filter"), u = f.search_box.querySelector(".slot_out_type_filter");
          } else {
            u = t = !1;
          }
          for (k in g.searchbox_extras) {
            var l = g.searchbox_extras[k];
            if (b.show_all_if_empty && !d || -1 !== l.desc.toLowerCase().indexOf(d)) {
              var x = g.registered_node_types[l.type];
              if ((!x || x.filter == p) && e(l.type) && (a(l.desc, "searchbox_extra"), -1 !== n.search_limit && q++ > n.search_limit)) {
                break;
              }
            }
          }
          ...
          if (Array.prototype.filter) {
            l = Object.keys(g.registered_node_types).filter(e);
          } else {
            for (k in l = [], g.registered_node_types) {
              e(k) && l.push(k);
            }
          }
          for (k = 0; k < l.length && !(a(l[k]), -1 !== n.search_limit && q++ > n.search_limit); k++) {
          }
          if (b.show_general_after_typefiltered && (t.value || u.value)) {
            filtered_extra = [];
            for (k in g.registered_node_types) {
              e(k, {inTypeOverride:t && t.value ? "*" : !1, outTypeOverride:u && u.value ? "*" : !1}) && filtered_extra.push(k);
            }
            for (k = 0; k < filtered_extra.length && !(a(filtered_extra[k], "generic_type"), -1 !== n.search_limit && q++ > n.search_limit); k++) {
            }
          }
          if ((t.value || u.value) && 0 == m.childNodes.length && b.show_general_if_none_on_typefilter) {
            filtered_extra = [];
            for (k in g.registered_node_types) {
    ...
    var f = this, h = n.active_canvas, k = h.canvas, q = k.ownerDocument || document, t = document.createElement("div");
    ...
    f.search_box = t;
    var m = t.querySelector(".helper"), r = null, A = null, w = null, y = t.querySelector("input");
...
(function(r) {
  ...
  w.prototype.onDrawBackground = function(m, r, n, w) {
    this.flags.collapsed || (r = this.size[1] - l.NODE_TITLE_HEIGHT + 0.5, n = l.isInsideRectangle(w[0], w[1], this.pos[0], this.pos[1] + r, this.size[0], l.NODE_TITLE_HEIGHT), w = l.isInsideRectangle(w[0], w[1], this.pos[0], this.pos[1] + r, this.size[0] / 2, l.NODE_TITLE_HEIGHT), m.fillStyle = n ? "#555" : "#222", m.beginPath(), this._shape == l.BOX_SHAPE ? w ? m.rect(0, r, this.size[0] / 2 + 1, l.NODE_TITLE_HEIGHT) : m.rect(this.size[0] / 2, r, this.size[0] / 2 + 1, l.NODE_TITLE_HEIGHT) : w ? 
    m.roundRect(0, r, this.size[0] / 2 + 1, l.NODE_TITLE_HEIGHT, [0, 0, 8, 8]) : m.roundRect(this.size[0] / 2, r, this.size[0] / 2 + 1, l.NODE_TITLE_HEIGHT, [0, 0, 8, 8]), n ? m.fill() : m.fillRect(0, r, this.size[0] + 1, l.NODE_TITLE_HEIGHT), m.textAlign = "center", m.font = "24px Arial", m.fillStyle = n ? "#DDD" : "#999", m.fillText("+", 0.25 * this.size[0], r + 24), m.fillText("+", 0.75 * this.size[0], r + 24));
  };
  w.prototype.onMouseDown = function(m, r, n) {
    m = this.size[1] - l.NODE_TITLE_HEIGHT + 0.5;
    console.log(0);
    r[1] > m && (r[0] < this.size[0] / 2 ? (console.log(1), n.showSubgraphPropertiesDialog(this)) : (console.log(2), n.showSubgraphPropertiesDialogRight(this)));
  };
  ...
  w.prototype.clone = function() {
    var m = l.createNode(this.type), r = this.serialize();
    delete r.id;
    delete r.inputs;
    delete r.outputs;
    m.configure(r);
      ...
      if (r.outputs) {
        for (x = 0; x < r.outputs.length; ++x) {
          if ((w = r.outputs[x]) && w.links && w.links.length) {
            for (var D = 0; D < w.links.length && (!(y = r.graph.links[w.links[D]]) || m[y.target_id]); ++D) {
            }
          }
        }
      }
  ...
  m.prototype.onAction = function(m, r) {
    this.properties.type == l.EVENT && this.triggerSlot(0, r);
  };
  ...
  y.prototype.onAction = function(m, r) {
    this.properties.type == l.ACTION && this.graph.trigger(this.properties.name, r);
  };
