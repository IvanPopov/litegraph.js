...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(r, w, k) {
  r != Array.prototype && r != Object.prototype && (r[w] = k.value);
};
$jscomp.getGlobal = function(r) {
  return "undefined" != typeof window && window === r ? r : "undefined" != typeof global && null != global ? global : r;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(r, w, k, y) {
  if (w) {
    k = $jscomp.global;
    r = r.split(".");
    ...
    y = k[r];
    w = w(y);
    w != y && null != w && $jscomp.defineProperty(k, r, {configurable:!0, writable:!0, value:w});
  }
};
$jscomp.polyfill("Object.is", function(r) {
  return r ? r : function(r, k) {
    return r === k ? 0 !== r || 1 / r === 1 / k : r !== r && k !== k;
  };
}, "es6", "es3");
...
$jscomp.checkStringArgs = function(r, w, k) {
  if (null == r) {
...
$jscomp.polyfill("String.prototype.includes", function(r) {
  return r ? r : function(r, k) {
    return -1 !== $jscomp.checkStringArgs(this, r, "includes").indexOf(r, k || 0);
  };
}, "es6", "es3");
$jscomp.owns = function(r, w) {
...
$jscomp.Symbol = function() {
  var r = 0;
  return function(w) {
    return $jscomp.SYMBOL_PREFIX + (w || "") + r++;
  };
}();
...
$jscomp.arrayIterator = function(r) {
  ...
  return $jscomp.iteratorPrototype(function() {
    return w < r.length ? {done:!1, value:r[w++]} : {done:!0};
  });
};
...
$jscomp.iteratorFromArray = function(r, w) {
  $jscomp.initSymbolIterator();
  r instanceof String && (r += "");
  var k = 0, y = {next:function() {
    if (k < r.length) {
      var n = k++;
      return {value:w(n, r[n]), done:!1};
    }
    y.next = function() {
...
$jscomp.polyfill("Array.prototype.fill", function(r) {
  return r ? r : function(r, k, y) {
    var n = this.length || 0;
    0 > k && (k = Math.max(0, n + k));
    if (null == y || y > n) {
      y = n;
    }
    y = Number(y);
    0 > y && (y = Math.max(0, n + y));
    for (k = Number(k || 0); k < y; k++) {
      this[k] = r;
    }
    return this;
  };
...
$jscomp.polyfill("Array.prototype.values", function(r) {
  return r ? r : function() {
    return $jscomp.iteratorFromArray(this, function(r, k) {
      return k;
    });
  };
}, "es8", "es3");
...
$jscomp.polyfill("String.prototype.startsWith", function(r) {
  return r ? r : function(r, k) {
    var w = $jscomp.checkStringArgs(this, r, "startsWith");
    r += "";
    var n = w.length, x = r.length;
    k = Math.max(0, Math.min(k | 0, w.length));
    for (var A = 0; A < x && k < n;) {
      if (w[k++] != r[A++]) {
        return !1;
      }
...
$jscomp.findInternal = function(r, w, k) {
...
$jscomp.polyfill("Array.prototype.findIndex", function(r) {
  return r ? r : function(r, k) {
    return $jscomp.findInternal(this, r, k).i;
  };
}, "es6", "es3");
(function(r) {
  function w(a, b, c) {
  ...
  function m(a, b, c) {
    ...
    this.default_connection_color_byType = {number:"#1da144", float:"#1da144", uint:"#ffb066", int:"#FFD166", boolean:"#EF476F", bool:"#EF476F", float3:"#FFD166", float2:"#45D592", float4:"#06D6A0", string:"#77F"};
    this.default_connection_color_byTypeOff = {number:"#1da144", float:"#1da144", uint:"#ffb066", int:"#FFD166", boolean:"#EF476F", bool:"#EF476F", float3:"#FFD166", float2:"#45D592", float4:"#06D6A0", string:"#77F"};
  ...
  function F(a, b) {
    ...
    d = b.left || 0;
    a = b.top || 0;
    b.event && (d = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (d = b.parentMenu.root.getBoundingClientRect(), d = d.left + d.width), h = document.body.getBoundingClientRect(), l = f.getBoundingClientRect(), 0 == h.height && console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"), h.width && d > h.width - l.width - 10 && (d = h.width - l.width - 10), h.height && a > h.height - l.height - 10 && (a = h.height - l.height - 
    10));
    f.style.left = d + "px";
    f.style.top = a + "px";
  ...
  slot_types_default_in:[], slot_types_default_out:[], alt_drag_do_clone_nodes:!1, do_add_triggers_slots:!1, allow_multi_output_for_events:!0, draw_invisible_connections:!1, middle_click_slot_add_default_node:!1, middle_click_canvas_dragging:!1, release_link_on_empty_shows_menu:!1, pointerevents_method:"mouse", registerNodeType:function(a, b) {
    ...
    b.title || (b.title = c);
    if (b.prototype) {
      for (var d in n.prototype) {
        b.prototype[d] || (b.prototype[d] = n.prototype[d]);
      }
    }
    ...
    for (var f = Array(b.length), h = "", l = g.getParameterNames(b), q = 0; q < l.length; ++q) {
      h += "this.addInput('" + l[q] + "'," + (c && c[q] ? "'" + c[q] + "'" : "0") + ");\n";
    }
  ...
  k.prototype.runStep = function(a, b, c) {
    a = a || 1;
    var e = g.getTime();
    ...
    if (d) {
      ...
      if (b) {
        ...
        try {
          for (f = 0; f < a; f++) {
            for (h = 0; h < c; ++h) {
              if (l = d[h], l.mode == g.ALWAYS && l.onExecute) {
                l.onExecute();
              }
            }
            this.fixedtime += this.fixedtime_lapse;
  ...
  k.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], e = [], d = {}, f = {}, h = {}, l = 0, q = this._nodes.length; l < q; ++l) {
      var t = this._nodes[l];
      if (!a || t.onExecute) {
        d[t.id] = t;
        var u = 0;
        if (t.inputs) {
          for (var p = 0, m = t.inputs.length; p < m; p++) {
            t.inputs[p] && null != t.inputs[p].link && (u += 1);
          }
        }
        0 == u ? (e.push(t), b && (t._level = 1)) : (b && (t._level = 0), h[t.id] = u);
      }
    }
    for (; 0 != e.length;) {
      if (t = e.shift(), c.push(t), delete d[t.id], t.outputs) {
        for (l = 0; l < t.outputs.length; l++) {
          if (a = t.outputs[l], null != a && null != a.links && 0 != a.links.length) {
            for (p = 0; p < a.links.length; p++) {
              (q = this.links[a.links[p]]) && !f[q.id] && (u = this.getNodeById(q.target_id), null == u ? f[q.id] = !0 : (b && (!u._level || u._level <= t._level) && (u._level = t._level + 1), f[q.id] = !0, --h[u.id], 0 == h[u.id] && e.push(u)));
            }
          }
        }
      }
  ...
  k.prototype.arrange = function(a, b) {
    a = a || 100;
    ...
    for (d = 0; d < e.length; ++d) {
      if (h = e[d]) {
        for (var l = 100, q = a + g.NODE_TITLE_HEIGHT, t = 0; t < h.length; ++t) {
          f = h[t], f.pos[0] = b == g.VERTICAL_LAYOUT ? q : c, f.pos[1] = b == g.VERTICAL_LAYOUT ? c : q, max_size_index = b == g.VERTICAL_LAYOUT ? 1 : 0, f.size[max_size_index] > l && (l = f.size[max_size_index]), node_size_index = b == g.VERTICAL_LAYOUT ? 0 : 1, q += f.size[node_size_index] + a + g.NODE_TITLE_HEIGHT;
        }
        c += l + a;
      }
    }
  ...
  k.prototype.findNodesByClass = function(a, b) {
    b = b || [];
  ...
  k.prototype.findNodesByType = function(a, b) {
    a = a.toLowerCase();
    b = b || [];
    for (var c = b.length = 0, e = this._nodes.length; c < e; ++c) {
  ...
  k.prototype.findNodeByTitle = function(a) {
  ...
  k.prototype.getNodesOnPos = function(a, b, c, e) {
    c = c || this._nodes;
  ...
  k.prototype.checkNodeTypes = function() {
    for (var a = 0; a < this._nodes.length; a++) {
      var b = this._nodes[a];
  ...
  k.prototype.onAction = function(a, b, c) {
  ...
  k.prototype.addInput = function(a, b, c) {
    if (!this.inputs[a]) {
      this.beforeChange();
  ...
  k.prototype.setInputData = function(a, b) {
    if (a = this.inputs[a]) {
      a.value = b;
    }
  };
  k.prototype.getInputData = function(a) {
    return (a = this.inputs[a]) ? a.value : null;
  };
  k.prototype.renameInput = function(a, b) {
    if (b != a) {
      if (!this.inputs[a]) {
        return !1;
      }
  ...
  k.prototype.changeInputType = function(a, b) {
    if (!this.inputs[a]) {
      return !1;
    }
  ...
  k.prototype.addOutput = function(a, b, c) {
  ...
  k.prototype.renameOutput = function(a, b) {
    if (!this.outputs[a]) {
      return !1;
    }
    if (this.outputs[b]) {
  ...
  k.prototype.changeOutputType = function(a, b) {
    if (!this.outputs[a]) {
      return !1;
    }
  ...
  k.prototype.beforeChange = function(a) {
    if (this.onBeforeChange) {
      this.onBeforeChange(this, a);
    }
    this.sendActionToCanvas("onBeforeChange", this);
  };
  k.prototype.afterChange = function(a) {
    ...
    if (a) {
      ...
      if (b) {
        ...
        for (d = b.length; e < d; ++e) {
          ...
          h || (g.debug && console.log("Node not found or has errors: " + f.type), h = new n, h.last_serialization = f, c = h.has_errors = !0);
          h.id = f.id;
          this.add(h, !0);
        }
        e = 0;
  ...
  n.prototype.serialize = function() {
    var a = {id:this.id, type:this.type, pos:this.pos, size:this.size, flags:g.cloneObject(this.flags), order:this.order, mode:this.mode, hide_input_connections:this.hide_input_connections};
  ...
  n.prototype.addOnTriggerInput = function() {
  ...
  n.prototype.addOnExecutedOutput = function() {
  ...
  n.prototype.onAfterExecuteNode = function(a, b) {
    var c = this.findOutputSlot("onExecuted");
    -1 != c && this.triggerSlot(c, a, null, b);
  };
  n.prototype.changeMode = function(a) {
    switch(a) {
      case g.ON_EVENT:
        break;
      case g.ON_TRIGGER:
  ...
  n.prototype.doExecute = function(a, b) {
    b = b || {};
  ...
  n.prototype.actionDo = function(a, b, c) {
    c = c || {};
  ...
  n.prototype.trigger = function(a, b, c) {
  ...
  n.prototype.triggerSlot = function(a, b, c, e) {
    e = e || {};
  ...
  n.prototype.addProperty = function(a, b, c, e) {
  ...
  n.prototype.addConnection = function(a, b, c, e) {
  ...
  n.prototype.computeSize = function(a) {
    ...
    d = Math.max(d, 1);
    var f = g.NODE_TEXT_SIZE, h = b(this.title), l = 0, q = 0;
    if (c) {
    ...
    if (e) {
      for (t = 0, u = e.length; t < u; ++t) {
        c = e[t], p = c.label || c.name || "", p = b(p), q < p && (q = p);
      }
    }
    a[0] = Math.max(l + q + 10, h);
    ...
    if (this.widgets && this.widgets.length) {
      t = 0;
      for (u = this.widgets.length; t < u; ++t) {
        e = this.widgets[t].computeSize ? e + (this.widgets[t].computeSize(a[0])[1] + 4) : e + (g.NODE_WIDGET_HEIGHT + 4);
      }
      e += 8;
    }
  ...
  n.prototype.addWidget = function(a, b, c, e, d) {
  ...
  n.prototype.isPointInside = function(a, b, c, e) {
    c = c || 0;
  ...
  n.prototype.findInputSlot = function(a, b) {
    if (!this.inputs) {
      return -1;
    }
  ...
  n.prototype.findOutputSlot = function(a, b) {
    b = b || !1;
    if (!this.outputs) {
      return -1;
    }
  ...
  n.prototype.findInputSlotFree = function(a) {
    a = a || {};
  ...
  n.prototype.findOutputSlotFree = function(a) {
    a = a || {};
    a = Object.assign({returnObj:!1, typesNotAccepted:[]}, a);
    if (!this.outputs) {
      return -1;
  ...
  n.prototype.findInputSlotByType = function(a, b, c, e) {
    return this.findSlotByType(!0, a, b, c, e);
  };
  n.prototype.findOutputSlotByType = function(a, b, c, e) {
    return this.findSlotByType(!1, a, b, c, e);
  };
  n.prototype.findSlotByType = function(a, b, c, e, d) {
    c = c || !1;
    e = e || !1;
    d = d || !1;
    ...
    for (var f = 0, h = a.length; f < h; ++f) {
      var l = (b + "").toLowerCase().split(","), q = "0" == a[f].type || "*" == a[f].type ? "0" : a[f].type;
      q = (q + "").toLowerCase().split(",");
      for (sI = 0; sI < l.length; sI++) {
        for (dI = 0; dI < q.length; dI++) {
          if ("_event_" == l[sI] && (l[sI] = g.EVENT), "_event_" == q[sI] && (q[sI] = g.EVENT), "*" == l[sI] && (l[sI] = 0), "*" == q[sI] && (q[sI] = 0), !(l[sI] != q[dI] || e && a[f].links && null !== a[f].links)) {
            return c ? a[f] : f;
          }
        }
      }
    ...
    if (e && !d) {
      for (f = 0, h = a.length; f < h; ++f) {
        for (l = (b + "").toLowerCase().split(","), q = "0" == a[f].type || "*" == a[f].type ? "0" : a[f].type, q = (q + "").toLowerCase().split(","), sI = 0; sI < l.length; sI++) {
          for (dI = 0; dI < q.length; dI++) {
            if ("*" == l[sI] && (l[sI] = 0), "*" == q[sI] && (q[sI] = 0), l[sI] == q[dI]) {
              return c ? a[f] : f;
            }
          }
        }
  ...
  n.prototype.connectByType = function(a, b, c, e) {
    e = e || {};
  ...
  n.prototype.connectByTypeOutput = function(a, b, c, e) {
    e = e || {};
  ...
  n.prototype.getConnectionPos = function(a, b, c) {
  ...
  x.prototype.isPointInside = n.prototype.isPointInside;
  x.prototype.setDirtyCanvas = n.prototype.setDirtyCanvas;
  g.DragAndScale = A;
  ...
  r.LGraphCanvas = g.LGraphCanvas = m;
  ...
  m.link_type_colors = {"-1":g.EVENT_LINK_COLOR, number:"#1da144", float:"#1da144", uint:"#ffb066", int:"#FFD166", boolean:"#EF476F", bool:"#EF476F", float3:"#FFD166", float2:"#45D592", float4:"#06D6A0", string:"#77F", node:"#DCA"};
  m.gradients = {};
            ...
            if (2 == a.which) {
              if (g.middle_click_canvas_dragging) {
                ...
                if (g.middle_click_slot_add_default_node && f && this.allow_interaction && !e && !this.read_only && !this.connecting_node && !f.flags.collapsed && !this.live_mode) {
                  d = e = h = !1;
                  if (f.outputs) {
                    for (u = 0, l = f.outputs.length; u < l; ++u) {
                      if (q = f.outputs[u], t = f.getConnectionPos(!1, u), B(a.canvasX, a.canvasY, t[0] - 15, t[1] - 10, 30, 20)) {
                        h = q;
                        e = u;
                        d = !0;
                        break;
                  ...
                  if (f.inputs) {
                    for (u = 0, l = f.inputs.length; u < l; ++u) {
                      if (q = f.inputs[u], t = f.getConnectionPos(!0, u), B(a.canvasX, a.canvasY, t[0] - 15, t[1] - 10, 30, 20)) {
                        h = q;
                        e = u;
                        d = !1;
                        break;
            ...
            if (f && this.allow_interaction && !e && !this.read_only) {
              ...
              if (!this.connecting_node && !f.flags.collapsed && !this.live_mode) {
                if (!e && !1 !== f.resizable && B(a.canvasX, a.canvasY, f.pos[0] + f.size[0] - 5, f.pos[1] + f.size[1] - 5, 10, 10)) {
                  ...
                  if (f.outputs) {
                    u = 0;
                    for (var l = f.outputs.length; u < l; ++u) {
                      var q = f.outputs[u], t = f.getConnectionPos(!1, u);
                      if (B(a.canvasX, a.canvasY, t[0] - 15, t[1] - 10, 30, 20) && (!1 !== q.visible || g.draw_invisible_connections)) {
                  ...
                  if (f.inputs) {
                    for (u = 0, l = f.inputs.length; u < l; ++u) {
                      if (q = f.inputs[u], t = f.getConnectionPos(!0, u), B(a.canvasX, a.canvasY, t[0] - 15, t[1] - 10, 30, 20) && (!1 !== q.visible || g.draw_invisible_connections)) {
                        if (d) {
                        ...
                        null !== q.link && (t = this.graph.links[q.link], g.click_do_break_link_to && (f.disconnectInput(u), e = this.dirty_bgcanvas = !0), this.allow_reconnect_links || a.shiftKey) && (g.click_do_break_link_to || f.disconnectInput(u), this.connecting_node = this.graph._nodes_by_id[t.origin_id], this.connecting_slot = t.origin_slot, this.connecting_output = this.connecting_node.outputs[this.connecting_slot], this.connecting_pos = this.connecting_node.getConnectionPos(!1, this.connecting_slot), 
              ...
              if (!e) {
                ...
                f.onMouseDown && f.onMouseDown(a, l, this) ? u = !0 : (f.subgraph && !f.skip_subgraph_button && !f.flags.collapsed && l[0] > f.size[0] - g.NODE_TITLE_HEIGHT && 0 > l[1] && (c = this, setTimeout(function() {
              ...
              if (!e) {
                if (!this.read_only) {
                  for (u = 0; u < this.visible_links.length; ++u) {
                    if (h = this.visible_links[u], l = h._pos, !(!l || a.canvasX < l[0] - 4 || a.canvasX > l[0] + 4 || a.canvasY < l[1] - 4 || a.canvasY > l[1] + 4)) {
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (d) {
                ...
                if (this.connecting_node) {
                  if (this.connecting_output) {
                    if (f = this._highlight_input || [0, 0], !this.isOverNodeBox(d, a.canvasX, a.canvasY)) {
                      if (l = this.isOverNodeInput(d, a.canvasX, a.canvasY, f), -1 != l && d.inputs[l] && !1 !== d.inputs[l].visible) {
                        var q = d.inputs[l].type;
                        g.isValidConnection(this.connecting_output.type, q) && (this._highlight_input = f, this._highlight_input_slot = d.inputs[l]);
                      } else {
                        this._highlight_input_slot = this._highlight_input = null;
                      }
                    }
                  } else {
                    this.connecting_input && (f = this._highlight_output || [0, 0], this.isOverNodeBox(d, a.canvasX, a.canvasY) || (l = this.isOverNodeOutput(d, a.canvasX, a.canvasY, f), -1 != l && d.outputs[l] && !1 !== d.outputs[l].visible ? (q = d.outputs[l].type, g.isValidConnection(this.connecting_input.type, q) && (this._highlight_output = f)) : this._highlight_output = null));
                  }
                }
                ...
                for (c = 0; c < this.visible_links.length; ++c) {
                  if (l = this.visible_links[c], q = l._pos, !(!q || a.canvasX < q[0] - 4 || a.canvasX > q[0] + 4 || a.canvasY < q[1] - 4 || a.canvasY > q[1] + 4)) {
                    f = l;
                    break;
                  }
                }
    ...
    if (this.graph) {
      ...
      if (1 == a.which) {
        ...
        if (this.dragging_rectangle) {
          if (this.graph) {
            e = this.graph._nodes;
            var f = new Float32Array(4), h = Math.abs(this.dragging_rectangle[2]), l = Math.abs(this.dragging_rectangle[3]), q = 0 > this.dragging_rectangle[3] ? this.dragging_rectangle[1] - l : this.dragging_rectangle[1];
            ...
            this.dragging_rectangle[3] = l;
            if (!d || 10 < h && 10 < l) {
              d = [];
              for (h = 0; h < e.length; ++h) {
                l = e[h], l.getBounding(f), H(this.dragging_rectangle, f) && d.push(l);
              }
  ...
  m.prototype.isOverNodeInput = function(a, b, c, e) {
    if (a.inputs) {
  ...
  m.prototype.isOverNodeOutput = function(a, b, c, e) {
    if (a.outputs) {
        ...
        for (var f = 0; f < b.inputs.length; ++f) {
          ...
          if (!h.not_subgraph_input) {
            if (this.drawButton(20, e + 2, 180, d - 2)) {
              ...
              this.graph.beforeChange();
              var q = g.createNode(l);
              q ? (a.add(q), this.block_click = !1, this.last_click_position = null, this.selectNodes([q]), this.node_dragged = q, this.dragging_canvas = !1, q.setProperty("name", h.name), q.setProperty("type", h.type), this.node_dragged.pos[0] = this.graph_mouse[0] - 5, this.node_dragged.pos[1] = this.graph_mouse[1] - 5, this.graph.afterChange()) : console.error("graph input node not found:", l);
            }
            c.fillStyle = "#9C9";
            c.beginPath();
        ...
        for (var h = 0; h < b.outputs.length; ++h) {
          ...
          if (!l.not_subgraph_input) {
            if (this.drawButton(d - 200, e + 2, 180, f - 2)) {
              ...
              this.graph.beforeChange();
              var t = g.createNode(q);
              t ? (a.add(t), this.block_click = !1, this.last_click_position = null, this.selectNodes([t]), this.node_dragged = t, this.dragging_canvas = !1, t.setProperty("name", l.name), t.setProperty("type", l.type), this.node_dragged.pos[0] = this.graph_mouse[0] - 5, this.node_dragged.pos[1] = this.graph_mouse[1] - 5, this.graph.afterChange()) : console.error("graph input node not found:", q);
            }
            c.fillStyle = "#9C9";
            c.beginPath();
            ...
            c.fill();
            c.fillStyle = "#AAA";
            c.fillText(l.name, d - 200 + 30, e + 0.75 * f);
            c.fillStyle = "#777";
            c.fillText(l.type, d - 200 + 130, e + 0.75 * f);
            e += f;
          }
        }
      }
  ...
  m.prototype.drawButton = function(a, b, c, e, d, f, h, l) {
    var q = this.ctx;
    f = f || g.NODE_DEFAULT_COLOR;
    h = h || "#555";
    l = l || g.NODE_TEXT_COLOR;
    var t = b + g.NODE_TITLE_HEIGHT + 2, u = this.mouse, p = g.isInsideRectangle(u[0], u[1], a, t, c, e);
    t = (u = this.last_click_position) && g.isInsideRectangle(u[0], u[1], a, t, c, e);
    q.fillStyle = p ? h : f;
    t && (q.fillStyle = "#AAA");
    q.beginPath();
    q.roundRect(a, b, c, e, [4]);
    q.fill();
    null != d && d.constructor == String && (q.fillStyle = l, q.textAlign = "center", q.font = (0.65 * e | 0) + "px Arial", q.fillText(d, a + 0.5 * c, b + 0.75 * e), q.textAlign = "left");
    a = t && !this.block_click;
    t && this.blockClick();
    return a;
  };
  m.prototype.isAreaClicked = function(a, b, c, e, d) {
    var f = this.mouse;
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              ...
              if (!1 !== p.visible || g.draw_invisible_connections) {
                var m = p.type, x = p.shape;
                b.globalAlpha = f;
                this.connecting_output && !g.isValidConnection(p.type, t.type) && (b.globalAlpha = 0.4 * f);
                b.fillStyle = null != p.link ? p.color_on || this.default_connection_color_byType[m] || this.default_connection_color.input_on : p.color_off || this.default_connection_color.input_off;
                var v = a.getConnectionPos(!0, c, u);
                v[0] -= a.pos[0];
                v[1] -= a.pos[1];
                q < v[1] + 0.5 * g.NODE_SLOT_HEIGHT && (q = v[1] + 0.5 * g.NODE_SLOT_HEIGHT);
                b.beginPath();
                "array" == m && (x = g.GRID_SHAPE);
                p.type === g.EVENT || p.shape === g.BOX_SHAPE ? l ? b.rect(v[0] - 5 + 0.5, v[1] - 8 + 0.5, 10, 14) : b.rect(v[0] - 6 + 0.5, v[1] - 5 + 0.5, 14, 10) : x === g.ARROW_SHAPE ? (b.moveTo(v[0] + 8, v[1] + 0.5), b.lineTo(v[0] - 4, v[1] + 6 + 0.5), b.lineTo(v[0] - 4, v[1] - 6 + 0.5), b.closePath()) : x === g.GRID_SHAPE ? (b.rect(v[0] - 4, v[1] - 4, 2, 2), b.rect(v[0] - 1, v[1] - 4, 2, 2), b.rect(v[0] + 2, v[1] - 4, 2, 2), b.rect(v[0] - 4, v[1] - 1, 2, 2), b.rect(v[0] - 1, v[1] - 1, 2, 2), 
                ...
                b.stroke();
                p.link && b.fill();
                e && (m = null != p.label ? p.label : p.name) && (b.fillStyle = g.NODE_TEXT_COLOR, l || p.dir == g.UP ? b.fillText(m, v[0], v[1] - 10) : b.fillText(m, v[0] + 10, v[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (p = a.outputs[c], !1 !== p.visible || g.draw_invisible_connections) {
                if (m = p.type, x = p.shape, this.connecting_input && !g.isValidConnection(m, h.type) && (b.globalAlpha = 0.4 * f), v = a.getConnectionPos(!1, c, u), v[0] -= a.pos[0], v[1] -= a.pos[1], q < v[1] + 0.5 * g.NODE_SLOT_HEIGHT && (q = v[1] + 0.5 * g.NODE_SLOT_HEIGHT), b.fillStyle = p.links && p.links.length ? p.color_on || this.default_connection_color_byType[m] || this.default_connection_color.output_on : p.color_off || this.default_connection_color_byTypeOff[m] || this.default_connection_color_byType[m] || 
                this.default_connection_color.output_off, b.beginPath(), "array" == m && (x = g.GRID_SHAPE), t = !0, m === g.EVENT || x === g.BOX_SHAPE ? l ? b.rect(v[0] - 5 + 0.5, v[1] - 8 + 0.5, 10, 14) : b.rect(v[0] - 6 + 0.5, v[1] - 5 + 0.5, 14, 10) : x === g.ARROW_SHAPE ? (b.moveTo(v[0] + 8, v[1] + 0.5), b.lineTo(v[0] - 4, v[1] + 6 + 0.5), b.lineTo(v[0] - 4, v[1] - 6 + 0.5), b.closePath()) : x === g.GRID_SHAPE ? (b.rect(v[0] - 4, v[1] - 4, 2, 2), b.rect(v[0] - 1, v[1] - 4, 2, 2), b.rect(v[0] + 
                2, v[1] - 4, 2, 2), b.rect(v[0] - 4, v[1] - 1, 2, 2), b.rect(v[0] - 1, v[1] - 1, 2, 2), b.rect(v[0] + 2, v[1] - 1, 2, 2), b.rect(v[0] - 4, v[1] + 2, 2, 2), b.rect(v[0] - 1, v[1] + 2, 2, 2), b.rect(v[0] + 2, v[1] + 2, 2, 2), t = !1) : d ? b.rect(v[0] - 4, v[1] - 4, 8, 8) : b.arc(v[0], v[1], 4, 0, 2 * Math.PI), b.strokeStyle = b.fillStyle, b.stroke(), p.links && p.links.length && b.fill(), !d && t && b.stroke(), e && (m = null != p.label ? p.label : p.name)) {
                  b.fillStyle = g.NODE_TEXT_COLOR, l || p.dir == g.DOWN ? b.fillText(m, v[0], v[1] - 8) : b.fillText(m, v[0] - 10, v[1] + 4);
                }
              }
            }
          }
          ...
          if (this.render_collapsed_slots) {
            ...
            f && (f = 0, c = -0.5 * g.NODE_TITLE_HEIGHT, l && (f = 0.5 * a._collapsed_width, c = -g.NODE_TITLE_HEIGHT), b.fillStyle = "#686", b.beginPath(), p.type === g.EVENT || p.shape === g.BOX_SHAPE ? b.rect(f - 7 + 0.5, c - 4, 14, 8) : p.shape === g.ARROW_SHAPE ? (b.moveTo(f + 8, c), b.lineTo(f + -4, c - 4), b.lineTo(f + -4, c + 4), b.closePath()) : b.arc(f, c, 4, 0, 2 * Math.PI), b.fill());
            d && (f = a._collapsed_width, c = -0.5 * g.NODE_TITLE_HEIGHT, l && (f = 0.5 * a._collapsed_width, c = 0), b.fillStyle = "#686", b.strokeStyle = "black", b.beginPath(), p.type === g.EVENT || p.shape === g.BOX_SHAPE ? b.rect(f - 7 + 0.5, c - 4, 14, 8) : p.shape === g.ARROW_SHAPE ? (b.moveTo(f + 6, c), b.lineTo(f - 6, c - 4), b.lineTo(f - 6, c + 4), b.closePath()) : b.arc(f, c, 4, 0, 2 * Math.PI), b.fill());
          }
        }
  ...
  m.prototype.drawNodeShape = function(a, b, c, e, d, f, h) {
    b.strokeStyle = e;
    b.fillStyle = d;
    d = g.NODE_TITLE_HEIGHT;
    var l = 0.5 > this.ds.scale, q = a._shape || a.constructor.shape || g.ROUND_SHAPE, t = a.constructor.title_mode, u = !0;
    t == g.TRANSPARENT_TITLE || t == g.NO_TITLE ? u = !1 : t == g.AUTOHIDE_TITLE && h && (u = !0);
    z[0] = -1;
    z[1] = u ? -d - 1 : 0;
    z[2] = c[0] + 3;
    z[3] = u ? c[1] + d + 2 : c[1];
    h = b.globalAlpha;
    b.beginPath();
    q == g.BOX_SHAPE || l ? b.fillRect(z[0], z[1], z[2], z[3]) : q == g.ROUND_SHAPE || q == g.CARD_SHAPE ? b.roundRect(z[0], z[1], z[2], z[3], q == g.CARD_SHAPE ? [this.round_radius, this.round_radius, 0, 0] : [this.round_radius]) : q == g.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0], 0, 2 * Math.PI);
    b.fill();
    b.shadowColor = "transparent";
    if (a.onDrawBackground) {
      a.onDrawBackground(b, this, this.canvas, this.graph_mouse);
    }
    if (u || t == g.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        a.onDrawTitleBar(b, d, c, this.ds.scale, e);
      } else {
        if (t != g.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          u = a.constructor.title_color || e;
          a.flags.collapsed && (b.shadowColor = g.DEFAULT_SHADOW_COLOR);
          if (this.use_gradients) {
            var p = m.gradients[u];
            p || (p = m.gradients[u] = b.createLinearGradient(0, 0, 400, 0), p.addColorStop(0, u), p.addColorStop(1, "#000"));
            b.fillStyle = p;
          } else {
            b.fillStyle = u;
          }
          b.beginPath();
          q == g.BOX_SHAPE || l ? b.rect(0, -d, c[0] + 1, d) : (q == g.ROUND_SHAPE || q == g.CARD_SHAPE) && b.roundRect(0, -d, c[0] + 1, d, a.flags.collapsed ? [this.round_radius] : [this.round_radius, this.round_radius, 0, 0]);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      ...
      if (a.onDrawTitleBox) {
        ...
        q == g.ROUND_SHAPE || q == g.CIRCLE_SHAPE || q == g.CARD_SHAPE ? (l && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * d, -0.5 * d, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || u || g.NODE_DEFAULT_BOXCOLOR, l ? b.fillRect(0.5 * d - 5, -0.5 * d - 5, 10, 10) : (b.beginPath(), b.arc(0.5 * d, -0.5 * d, 5, 0, 2 * Math.PI), b.fill())) : (l && (b.fillStyle = "black", b.fillRect(0.5 * (d - 10) - 1, -0.5 * (d + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || u || g.NODE_DEFAULT_BOXCOLOR, 
    ...
    if (f) {
      ...
      t == g.TRANSPARENT_TITLE && (z[1] -= d, z[3] += d);
      b.lineWidth = 1;
      b.globalAlpha = 0.8;
      b.beginPath();
      ...
      if (f.inputs && f.inputs.length) {
        for (var h = 0; h < f.inputs.length; ++h) {
          ...
          if (l && null != l.link && (l = this.graph.links[l.link])) {
            var q = this.graph.getNodeById(l.origin_id);
            if (null != q) {
              var t = l.origin_slot;
              var u = -1 == t ? [q.pos[0] + 10, q.pos[1] + 10] : q.getConnectionPos(!1, t, K);
              ...
              if (H(C, I)) {
                var m = q.outputs[t], x = f.inputs[h];
                if (m && x) {
                  t = !!f.hide_input_connections;
                  var v = !1 === m.visible || !1 === x.visible;
                  if (!v || g.draw_invisible_connections) {
                    q = m.dir || (q.horizontal ? g.DOWN : g.RIGHT), x = x.dir || (f.horizontal ? g.UP : g.LEFT), this.renderLink(a, u, p, l, !1, 0, v ? "red" : null, q, x, 1, t), l && l._last_time && 1000 > b - l._last_time && (v = 2.0 - 0.002 * (b - l._last_time), m = a.globalAlpha, a.globalAlpha = m * v, this.renderLink(a, u, p, l, !0, v, "white", q, x, 1, t), a.globalAlpha = m);
                  }
                }
              }
            }
  ...
  m.prototype.renderLink = function(a, b, c, e, d, f, h, l, q, t, u, p) {
    e && this.visible_links.push(e);
    p = p || G(b, c);
    !h && e && (h = e.color || m.link_type_colors[e.type]);
    h || (h = this.default_link_color);
    if (null != e && this.highlighted_links[e.id]) {
      h = "#FFF";
    } else {
      if (!0 === u) {
        var x = Math.min(50 / p, 1);
        u = [c[0] - b[0], c[1] - b[1]];
        this.renderLink(a, b, [b[0] + u[0] * x, b[1] + u[1] * x], e, d, f, h, l, q, t, 1);
        this.renderLink(a, [b[0] + u[0] * (1 - x), b[1] + u[1] * (1 - x)], c, e, d, f, h, l, q, t, 1);
        return;
      }
    }
    l = l || g.RIGHT;
    ...
    a.beginPath();
    for (x = 0; x < t; x += 1) {
      var n = 5 * (x - 0.5 * (t - 1)), v = u && !this.highlighted_links[e.id], k = v ? g.LINEAR_LINK : this.links_render_mode;
      if (k == g.SPLINE_LINK) {
        a.moveTo(b[0], b[1] + n);
        var r = k = 0, A = 0, y = 0;
        switch(l) {
        ...
        a.bezierCurveTo(b[0] + k, b[1] + r + n, c[0] + A, c[1] + y + n, c[0], c[1] + n);
      } else {
        if (k == g.LINEAR_LINK) {
          a.moveTo(b[0], b[1] + n);
          y = A = r = k = 0;
          ...
          v = v ? 0 : 15;
          a.lineTo(b[0] + k * v, b[1] + r * v + n);
          a.lineTo(c[0] + A * v, c[1] + y * v + n);
          a.lineTo(c[0], c[1] + n);
        } else {
          if (k == g.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), n = b[0], v = b[1], k = c[0], r = c[1], l == g.RIGHT ? n += 10 : v += 10, q == g.LEFT ? k -= 10 : r -= 10, a.lineTo(n, v), a.lineTo(0.5 * (n + k), v), a.lineTo(0.5 * (n + k), r), a.lineTo(k, r), a.lineTo(c[0], c[1]);
          } else {
            return;
          }
        }
    ...
    u ? a.setLineDash([5, 3]) : a.setLineDash([]);
    a.lineWidth = this.connections_width;
    ...
    a.stroke();
    d = this.computeConnectionPoint(b, c, 0.5, l, q);
    e && e._pos && (e._pos[0] = d[0], e._pos[1] = d[1]);
    0.6 <= this.ds.scale && this.highquality_render && q != g.CENTER && (this.render_connection_arrows && (e = this.computeConnectionPoint(b, c, 0.25, l, q), u = this.computeConnectionPoint(b, c, 0.26, l, q), t = this.computeConnectionPoint(b, c, 0.75, l, q), x = this.computeConnectionPoint(b, c, 0.76, l, q), this.render_curved_connections ? (u = -Math.atan2(u[0] - e[0], u[1] - e[1]), x = -Math.atan2(x[0] - t[0], x[1] - t[1])) : x = u = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(e[0], e[1]), 
    a.rotate(u), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(t[0], t[1]), a.rotate(x), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), this.render_link_center && (a.beginPath(), a.arc(d[0], d[1], 5, 0, 2 * Math.PI), a.fill()));
    if (f) {
      for (a.fillStyle = h, x = 0; 5 > x; ++x) {
        f = (0.001 * g.getTime() + 0.2 * x) % 1, d = this.computeConnectionPoint(b, c, f, l, q), a.beginPath(), a.arc(d[0], d[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  m.prototype.computeConnectionPoint = function(a, b, c, e, d) {
    e = e || g.RIGHT;
    d = d || g.LEFT;
    var f = G(a, b), h = [a[0], a[1]], l = [b[0], b[1]];
    switch(e) {
      case g.LEFT:
        h[0] += -0.25 * f;
        break;
    ...
    f = 3 * (1 - c) * c * c;
    c *= c * c;
    return [e * a[0] + d * h[0] + f * l[0] + c * b[0], e * a[1] + d * h[1] + f * l[1] + c * b[1]];
  };
  ...
  m.prototype.drawNodeWidgets = function(a, b, c, e) {
    ...
    for (var q = g.WIDGET_OUTLINE_COLOR, t = g.WIDGET_BGCOLOR, m = g.WIDGET_TEXT_COLOR, p = g.WIDGET_SECONDARY_TEXT_COLOR, x = 0; x < f.length; ++x) {
      var k = f[x], v = b;
      k.y && (v = k.y);
      k.last_y = v;
      c.strokeStyle = q;
      c.fillStyle = "#222";
      c.textAlign = "left";
      k.disabled && (c.globalAlpha *= 0.5);
      var n = k.width || d;
      switch(k.type) {
        case "button":
          k.clicked && (c.fillStyle = "#AAA", k.clicked = !1, this.dirty_canvas = !0);
          c.fillRect(15, v, n - 30, h);
          l && !k.disabled && c.strokeRect(15, v, n - 30, h);
          l && (c.textAlign = "center", c.fillStyle = m, c.fillText(k.name, 0.5 * n, v + 0.7 * h));
          break;
        case "toggle":
          c.textAlign = "left";
          c.strokeStyle = q;
          c.fillStyle = t;
          c.beginPath();
          l ? c.roundRect(15, v, n - 30, h, [0.5 * h]) : c.rect(15, v, n - 30, h);
          c.fill();
          l && !k.disabled && c.stroke();
          c.fillStyle = k.value ? "#89A" : "#333";
          c.beginPath();
          c.arc(n - 30, v + 0.5 * h, 0.36 * h, 0, 2 * Math.PI);
          c.fill();
          l && (c.fillStyle = p, null != k.name && c.fillText(k.name, 30, v + 0.7 * h), c.fillStyle = k.value ? m : p, c.textAlign = "right", c.fillText(k.value ? k.options.on || "true" : k.options.off || "false", n - 40, v + 0.7 * h));
          break;
        case "slider":
          c.fillStyle = t;
          c.fillRect(15, v, n - 30, h);
          var r = k.options.max - k.options.min, A = (k.value - k.options.min) / r;
          c.fillStyle = e == k ? "#89A" : "#678";
          c.fillRect(15, v, A * (n - 30), h);
          l && !k.disabled && c.strokeRect(15, v, n - 30, h);
          k.marker && (r = (k.marker - k.options.min) / r, c.fillStyle = "#AA9", c.fillRect(15 + r * (n - 30), v, 2, h));
          l && (c.textAlign = "center", c.fillStyle = m, c.fillText(k.name + "  " + Number(k.value).toFixed(3), 0.5 * n, v + 0.7 * h));
          break;
        case "number":
        case "combo":
          c.textAlign = "left";
          ...
          l ? c.roundRect(15, v, n - 30, h, [0.5 * h]) : c.rect(15, v, n - 30, h);
          c.fill();
          l && (k.disabled || c.stroke(), c.fillStyle = m, k.disabled || (c.beginPath(), c.moveTo(31, v + 5), c.lineTo(21, v + 0.5 * h), c.lineTo(31, v + h - 5), c.fill(), c.beginPath(), c.moveTo(n - 15 - 16, v + 5), c.lineTo(n - 15 - 6, v + 0.5 * h), c.lineTo(n - 15 - 16, v + h - 5), c.fill()), c.fillStyle = p, c.fillText(k.name, 35, v + 0.7 * h), c.fillStyle = m, c.textAlign = "right", "number" == k.type ? c.fillText(Number(k.value).toFixed(void 0 !== k.options.precision ? k.options.precision : 
          3), n - 30 - 20, v + 0.7 * h) : (r = k.value, k.options.values && (A = k.options.values, A.constructor === Function && (A = A()), A && A.constructor !== Array && (r = A[k.value])), c.fillText(r, n - 30 - 20, v + 0.7 * h)));
          break;
        case "string":
        case "text":
          c.textAlign = "left";
          ...
          l ? c.roundRect(15, v, n - 30, h, [0.5 * h]) : c.rect(15, v, n - 30, h);
          c.fill();
          l && (k.disabled || c.stroke(), c.save(), c.beginPath(), c.rect(15, v, n - 30, h), c.clip(), c.fillStyle = p, null != k.name && c.fillText(k.name, 30, v + 0.7 * h), c.fillStyle = m, c.textAlign = "right", c.fillText(String(k.value).substr(0, 30), n - 30, v + 0.7 * h), c.restore());
          break;
        default:
          k.draw && k.draw(c, a, n, v, h);
      }
      b += (k.computeSize ? k.computeSize(n)[1] : h) + 4;
      c.globalAlpha = this.editor_alpha;
    }
    c.restore();
    c.textAlign = "left";
  };
  m.prototype.processNodeWidgets = function(a, b, c, e) {
    function d(d, e) {
      d.value = e;
    ...
    for (var f = b[0] - a.pos[0], h = b[1] - a.pos[1], l = a.size[0], q = this, m = this.getCanvasWindow(), u = 0; u < a.widgets.length; ++u) {
      var p = a.widgets[u];
      if (p && !p.disabled) {
        var k = p.computeSize ? p.computeSize(l)[1] : g.NODE_WIDGET_HEIGHT, x = p.width || l;
        if (p == e || !(6 > f || f > x - 12 || h < p.last_y || h > p.last_y + k || void 0 === p.last_y)) {
          e = p.value;
          switch(p.type) {
            case "button":
              ...
              break;
            case "slider":
              m = Math.clamp((f - 15) / (x - 30), 0, 1);
              p.value = p.options.min + (p.options.max - p.options.min) * m;
            ...
            case "combo":
              ...
              if (c.type == g.pointerevents_method + "move" && "number" == p.type) {
                ...
                if (c.type == g.pointerevents_method + "down") {
                  ...
                  var n = null;
                  "number" != p.type && (n = v.constructor === Array ? v : Object.keys(v));
                  f = 40 > f ? -1 : f > x - 40 ? 1 : 0;
                  if ("number" == p.type) {
                    ...
                    if (f) {
                      m = -1, this.last_mouseclick = 0, m = v.constructor === Object ? n.indexOf(String(p.value)) + f : n.indexOf(p.value) + f, m >= n.length && (m = n.length - 1), 0 > m && (m = 0), p.value = v.constructor === Array ? v[m] : m;
                    } else {
                      var r = v != n ? Object.values(v) : v;
                      new g.ContextMenu(r, {scale:Math.max(1, this.ds.scale), event:c, className:"dark", callback:function(a, b, c) {
                        v != n && (a = r.indexOf(a));
                        this.value = a;
                        d(this, a);
                        q.dirty_canvas = !0;
  ...
  m.onMenuAdd = function(a, b, c, e, d) {
    function f(a, b) {
      var e = [];
      ...
      new g.ContextMenu(e, {event:c, parentMenu:b}, l);
    }
    var h = m.active_canvas, l = h.getCanvasWindow(), q = h.graph;
    if (q) {
      return f("", e), !1;
    }
  };
  ...
  m.showMenuNodeOptionalInputs = function(a, b, c, e, d) {
    if (d) {
      var f = this;
      ...
      if (b) {
        for (var l = 0; l < b.length; l++) {
          ...
          if (q) {
            var t = q[0];
            q[2] || (q[2] = {});
            q[2].label && (t = q[2].label);
            q[2].removable = !0;
            t = {content:t, value:q};
            q[1] == g.ACTION && (t.className = "event");
            h.push(t);
          } else {
            h.push(null);
          }
  ...
  m.showMenuNodeOptionalOutputs = function(a, b, c, e, d) {
    function f(a, b, c) {
    ...
    if (d) {
      ...
      if (b) {
        for (var q = 0; q < b.length; q++) {
          ...
          if (!t) {
            ...
            if (!d.flags || !d.flags.skip_repeated_outputs || -1 == d.findOutputSlot(t[0])) {
              var u = t[0];
              t[2] || (t[2] = {});
              t[2].label && (u = t[2].label);
              t[2].removable = !0;
              u = {content:u, value:t};
              t[1] == g.EVENT && (u.className = "event");
              l.push(u);
            }
          }
        }
      ...
      g.do_add_triggers_slots && -1 == d.findOutputSlot("onExecuted") && l.push({content:"On Executed", value:["onExecuted", g.EVENT, {nameLocked:!0}], className:"event"});
      d.onMenuNodeOutputs && (b = d.onMenuNodeOutputs(l)) && (l = b);
      if (l.length) {
        return new g.ContextMenu(l, {event:c, callback:f, parentMenu:e, node:d}, a), !1;
      }
    }
  };
  m.onShowMenuNodeProperties = function(a, b, c, e, d) {
    if (d && d.properties) {
      var f = m.active_canvas;
      b = f.getCanvasWindow();
      var h = [], l;
      for (l in d.properties) {
        a = void 0 !== d.properties[l] ? d.properties[l] : " ";
        "object" == typeof a && (a = JSON.stringify(a));
        var q = d.getPropertyInfo(l);
        if ("enum" == q.type || "combo" == q.type) {
          a = m.getPropertyPrintableValue(a, q.values);
        }
        a = m.decodeHTML(a);
        h.push({content:"<span class='property_name'>" + (q.label ? q.label : l) + "</span><span class='property_value'>" + a + "</span>", value:l});
      }
      if (h.length) {
  ...
  m.onMenuResizeNode = function(a, b, c, e, d) {
    if (d) {
      a = function(a) {
  ...
  m.prototype.showLinkMenu = function(a, b) {
    ...
    var l = new g.ContextMenu(["Add Node", null, "Delete", null], {event:b, title:null != a.data ? a.data.constructor.name : null, callback:function(b, g, u) {
      switch(b) {
        case "Add Node":
          m.onMenuAdd(null, null, u, l, function(b) {
  ...
  m.prototype.showConnectionMenu = function(a) {
    ...
    var h = d.type == g.EVENT ? "_event_" : d.type, l = e ? g.slot_types_default_out : g.slot_types_default_in;
    if (l && l[h]) {
    ...
    var t = new g.ContextMenu(a, {event:b.e, title:(d && "" != d.name ? d.name + (h ? " | " : "") : "") + (d && h ? h : ""), callback:function(a, g, l) {
      switch(a) {
        case "Add Node":
          m.onMenuAdd(null, null, l, t, function(a) {
            e ? b.nodeFrom.connectByType(f, a, h) : b.nodeTo.connectByTypeOutput(f, a, h);
          });
          break;
        case "Search":
          e ? c.showSearchBox(l, {node_from:b.nodeFrom, slot_from:d, type_filter_in:h}) : c.showSearchBox(l, {node_to:b.nodeTo, slot_from:d, type_filter_out:h});
          break;
        default:
  ...
  m.onShowPropertyEditor = function(a, b, c, e, d) {
    function f() {
      if (q) {
        var b = q.value;
    ...
    var t = e = -20;
    c && (e -= c.left, t -= c.top);
    event ? (l.style.left = event.clientX + e + "px", l.style.top = event.clientY + t + "px") : (l.style.left = 0.5 * b.width + e + "px", l.style.top = 0.5 * b.height + t + "px");
    l.querySelector("button").addEventListener("click", f);
    b.parentNode.appendChild(l);
    q && q.focus();
    var u = null;
    l.addEventListener("mouseleave", function(a) {
      g.dialog_close_on_mouse_leave && !l.is_modified && g.dialog_close_on_mouse_leave && (u = setTimeout(l.close, g.dialog_close_on_mouse_leave_delay));
    });
    l.addEventListener("mouseenter", function(a) {
      g.dialog_close_on_mouse_leave && u && clearTimeout(u);
    });
  };
  m.prototype.prompt = function(a, b, c, e, d) {
    var f = this;
    a = a || "";
    ...
    d = m.active_canvas.canvas;
    d.parentNode.appendChild(h);
    1 < this.ds.scale && (h.style.transform = "scale(" + this.ds.scale + ")");
    var l = null, q = !1;
    g.pointerListenerAdd(h, "leave", function(a) {
      q || g.dialog_close_on_mouse_leave && !h.is_modified && g.dialog_close_on_mouse_leave && (l = setTimeout(h.close, g.dialog_close_on_mouse_leave_delay));
    });
    ...
    t = b = -20;
    a && (b -= a.left, t -= a.top);
    e ? (h.style.left = e.clientX + b + "px", h.style.top = e.clientY + t + "px") : (h.style.left = 0.5 * d.width + b + "px", h.style.top = 0.5 * d.height + t + "px");
    setTimeout(function() {
      u.focus();
    }, 10);
    return h;
  ...
  m.prototype.showSearchBox = function(a, b) {
    ...
    function e(a) {
      ...
      w ? (w = a ? w.nextSibling : w.previousSibling) || (w = b) : w = a ? n.childNodes[0] : n.childNodes[n.childNodes.length];
      ...
      if (d || b.show_all_if_empty) {
        if (f.onSearchBox) {
          ...
          e = function(a, c) {
            ...
            if (p && e.filter != p || (!b.show_all_if_empty || d) && -1 === a.toLowerCase().indexOf(d)) {
              return !1;
            }
            if (b.do_type_filter && !c.skipFilter) {
              e = t.value;
              !1 !== c.inTypeOverride && (e = c.inTypeOverride);
              if (t && e && g.registered_slot_in_types[e] && g.registered_slot_in_types[e].nodes && (e = g.registered_slot_in_types[e].nodes.includes(a), !1 === e)) {
                return !1;
              }
              e = k.value;
              !1 !== c.outTypeOverride && (e = c.outTypeOverride);
              if (k && e && g.registered_slot_out_types[e] && g.registered_slot_out_types[e].nodes && (e = g.registered_slot_out_types[e].nodes.includes(a), !1 === e)) {
                return !1;
              }
            }
            return !0;
          ...
          var q = 0;
          d = d.toLowerCase();
          var p = h.filter || h.graph.filter;
          if (b.do_type_filter && f.search_box) {
            var t = f.search_box.querySelector(".slot_in_type_filter"), k = f.search_box.querySelector(".slot_out_type_filter");
          } else {
            k = t = !1;
          }
          for (l in g.searchbox_extras) {
            var u = g.searchbox_extras[l];
            if (b.show_all_if_empty && !d || -1 !== u.desc.toLowerCase().indexOf(d)) {
              var x = g.registered_node_types[u.type];
              if ((!x || x.filter == p) && e(u.type) && (a(u.desc, "searchbox_extra"), -1 !== m.search_limit && q++ > m.search_limit)) {
                break;
              }
            }
          }
          ...
          if (Array.prototype.filter) {
            ...
            for (l in u = [], g.registered_node_types) {
              e(l) && u.push(l);
            }
          }
          for (l = 0; l < u.length && !(a(u[l]), -1 !== m.search_limit && q++ > m.search_limit); l++) {
          }
          if (b.show_general_after_typefiltered && (t.value || k.value)) {
            filtered_extra = [];
            for (l in g.registered_node_types) {
              e(l, {inTypeOverride:t && t.value ? "*" : !1, outTypeOverride:k && k.value ? "*" : !1}) && filtered_extra.push(l);
            }
            for (l = 0; l < filtered_extra.length && !(a(filtered_extra[l], "generic_type"), -1 !== m.search_limit && q++ > m.search_limit); l++) {
            }
          }
          if ((t.value || k.value) && 0 == n.childNodes.length && b.show_general_if_none_on_typefilter) {
            filtered_extra = [];
            for (l in g.registered_node_types) {
              e(l, {skipFilter:!0}) && filtered_extra.push(l);
            }
            for (l = 0; l < filtered_extra.length && !(a(filtered_extra[l], "not_in_filter"), -1 !== m.search_limit && q++ > m.search_limit); l++) {
            }
          }
        }
      }
    ...
    var f = this, h = m.active_canvas, l = h.canvas, q = l.ownerDocument || document, t = document.createElement("div");
    t.className = "litegraph litesearchbox graphdialog rounded";
    t.innerHTML = "<span class='name'>Search</span> <input autofocus type='text' placeholder='search' class='value rounded'/>";
    ...
    q.fullscreenElement ? q.fullscreenElement.appendChild(t) : (q.body.appendChild(t), q.body.style.overflow = "hidden");
    if (b.do_type_filter) {
      var u = t.querySelector(".slot_in_type_filter"), p = t.querySelector(".slot_out_type_filter");
    }
    t.close = function() {
      f.search_box = null;
      this.blur();
    ...
    if (b.hide_on_mouse_leave) {
      var k = !1, x = null;
      g.pointerListenerAdd(t, "enter", function(a) {
        x && (clearTimeout(x), x = null);
      });
      g.pointerListenerAdd(t, "leave", function(a) {
    ...
    f.search_box = t;
    var n = t.querySelector(".helper"), r = null, A = null, w = null, y = t.querySelector("input");
    ...
    t.style.left = (a ? a.clientX : u.left + 0.5 * u.width) - 80 + "px";
    t.style.top = p + "px";
    a.layerY > u.height - 200 && (n.style.maxHeight = u.height - a.layerY - 20 + "px");
    y.focus();
      ...
      if ("string" == h || "number" == h || "array" == h || "object" == h) {
        ...
        if ("enum" != h && "combo" != h || !f.values) {
          ...
          for (var q in f.values) {
            var m = q;
            f.values.constructor === Array && (m = f.values[q]);
            g += "<option value='" + m + "' " + (m == a.properties[b] ? "selected" : "") + ">" + f.values[q] + "</option>";
          }
          g += "</select>";
        }
      }
      var k = this.createDialog("<span class='name'>" + (f.label ? f.label : b) + "</span>" + g + "<button>OK</button>", c), p = !1;
      if ("enum" != h && "combo" != h || !f.values) {
        if ("boolean" == h || "toggle" == h) {
          (p = k.querySelector("input")) && p.addEventListener("click", function(a) {
            k.modified();
            d(!!p.checked);
          });
        } else {
          if (p = k.querySelector("input")) {
            p.addEventListener("blur", function(a) {
              this.focus();
            }), m = void 0 !== a.properties[b] ? a.properties[b] : "", "string" !== h && (m = JSON.stringify(m)), p.value = m, p.addEventListener("keydown", function(a) {
              if (27 == a.keyCode) {
                k.close();
              } else {
                if (13 == a.keyCode) {
        ...
        p = k.querySelector("select"), p.addEventListener("change", function(a) {
          k.modified();
          d(a.target.value);
        });
      }
  ...
  m.prototype.createPanel = function(a, b) {
    ...
    e.addWidget = function(a, b, h, l, q) {
      function d(a, b) {
      ...
      p.querySelector(".property_name").innerText = l.label || b;
      var k = p.querySelector(".property_value");
      k.innerText = f;
      p.dataset.property = b;
      p.dataset.type = l.type || a;
      p.options = l;
      p.value = h;
      if ("code" == a) {
        p.addEventListener("click", function(a) {
        ...
        if ("boolean" == a) {
          ...
          if ("string" == a || "number" == a) {
            k.setAttribute("contenteditable", !0), k.addEventListener("keydown", function(b) {
            ...
            if ("enum" == a || "combo" == a) {
              f = m.getPropertyPrintableValue(h, l.values), k.innerText = f, k.addEventListener("click", function(a) {
  ...
  m.prototype.showShowGraphOptionsPanel = function(a, b, c, e) {
      ...
      var b = function(b, c) {
        ...
        switch(b) {
          ...
          case "Mode":
            ...
            break;
          case "Color":
            m.node_colors[c] ? (a.color = w(m.node_colors[c].color, 0.5), a.bgcolor = w(m.node_colors[c].bgcolor, 0.5)) : console.warn("unexpected color: " + c);
            break;
          default:
            a.setProperty(b, c);
        }
  ...
  m.onMenuNodeCollapse = function(a, b, c, e, d) {
    d.graph.beforeChange();
    a = m.active_canvas;
  ...
  m.onMenuNodePin = function(a, b, c, e, d) {
    d.pin();
  };
  m.onMenuNodeMode = function(a, b, c, e, d) {
  ...
  m.onMenuNodeColors = function(a, b, c, e, d) {
    if (!d) {
      throw "no node for color";
    }
    b = [];
    b.push({value:null, content:"<span style='display: block; padding-left: 4px;'>No color</span>"});
    for (var f in m.node_colors) {
      a = m.node_colors[f], a = {value:f, content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid " + a.color + "; background-color:" + a.bgcolor + "'>" + f + "</span>"}, b.push(a);
    }
  ...
  m.onMenuNodeShapes = function(a, b, c, e, d) {
    if (!d) {
  ...
  m.onMenuNodeRemove = function(a, b, c, e, d) {
    if (!d) {
      throw "no node passed";
    }
    a = d.graph;
  ...
  m.onMenuNodeToSubgraph = function(a, b, c, e, d) {
    a = d.graph;
  ...
  m.onMenuHideInputConnections = function(a, b, c, e, d) {
    d.graph.beforeChange();
    a = {};
    b = m.active_canvas;
    if (!b.selected_nodes || 1 >= Object.keys(b.selected_nodes).length) {
      d.hide_input_connections = !d.hide_input_connections;
    } else {
      for (var f in b.selected_nodes) {
        c = b.selected_nodes[f], c.hide_input_connections = !c.hide_input_connections;
      }
    }
    Object.keys(a).length && b.selectNodes(a);
    d.graph.afterChange();
    d.setDirtyCanvas(!0, !0);
  };
  m.onMenuNodeClone = function(a, b, c, e, d) {
    d.graph.beforeChange();
    var f = {};
    a = function(a) {
      if (0 != a.clonable) {
  ...
  m.prototype.getNodeMenuOptions = function(a) {
    ...
    b.push({content:!0 !== a.hide_input_connections ? "Hide Input Connections" : "Show Input Connections", callback:m.onMenuHideInputConnections});
  ...
  m.prototype.processContextMenu = function(a, b) {
    var c = this, e = m.active_canvas.getCanvasWindow(), d = null, f = {event:b, callback:function(b, d, e) {
      if (b) {
        if ("Remove Slot" == b.content) {
          ...
          if ("Disconnect Links" == b.content) {
            ...
            if ("Rename Slot" == b.content) {
              ...
              g.querySelector("button").addEventListener("click", l);
    ...
    a && (f.title = a.type);
    var h = null;
    a && (h = a.getSlotInPosition(b.canvasX, b.canvasY), m.active_node = a);
  ...
  F.prototype.addItem = function(a, b, c) {
    ...
    if (null === b) {
      ...
      if (h.value = b) {
        b.disabled && (l = !0, h.classList.add("disabled")), (b.submenu || b.has_submenu) && h.classList.add("has_submenu");
      }
      "function" == typeof b ? (h.dataset.value = a, h.onclick_callback = b) : h.dataset.value = b;
      b.className && (h.className += " " + b.className);
    }
    this.root.appendChild(h);
    l || h.addEventListener("click", d);
  ...
  D.prototype.getCloserPoint = function(a, b) {
    ...
    b = b || 30;
    for (var e = this.size[0] - 2 * this.margin, d = this.size[1] - 2 * this.margin, f = c.length, g = [0, 0], l = 1000000, m = -1, k = 0; k < f; ++k) {
      var x = c[k];
      g[0] = x[0] * e;
      g[1] = (1.0 - x[1]) * d;
      x = vec2.distance(a, g);
...
(function(r) {
  ...
  w.prototype.onDblClick = function(k, n, m) {
    var x = this;
    setTimeout(function() {
      m.openSubgraph(x.subgraph);
    }, 10);
  };
  w.prototype.onAction = function(k, n) {
    this.subgraph.onAction(k, n);
  };
  w.prototype.onExecute = function() {
    if (this.enabled = this.getInputOrProperty("enabled")) {
      if (this.inputs) {
        for (var k = 0; k < this.inputs.length; k++) {
          var n = this.inputs[k], m = this.getInputData(k);
          this.subgraph.setInputData(n.name, m);
        }
      }
      this.subgraph.runStep();
      if (this.outputs) {
        for (k = 0; k < this.outputs.length; k++) {
          m = this.subgraph.getOutputData(this.outputs[k].name), this.setOutputData(k, m);
        }
      }
    }
  };
  w.prototype.sendEventToAllNodes = function(k, n, m) {
    this.enabled && this.subgraph.sendEventToAllNodes(k, n, m);
  };
  w.prototype.onDrawBackground = function(k, r, m, w) {
    this.flags.collapsed || (r = this.size[1] - n.NODE_TITLE_HEIGHT + 0.5, m = n.isInsideRectangle(w[0], w[1], this.pos[0], this.pos[1] + r, this.size[0], n.NODE_TITLE_HEIGHT), w = n.isInsideRectangle(w[0], w[1], this.pos[0], this.pos[1] + r, this.size[0] / 2, n.NODE_TITLE_HEIGHT), k.fillStyle = m ? "#555" : "#222", k.beginPath(), this._shape == n.BOX_SHAPE ? w ? k.rect(0, r, this.size[0] / 2 + 1, n.NODE_TITLE_HEIGHT) : k.rect(this.size[0] / 2, r, this.size[0] / 2 + 1, n.NODE_TITLE_HEIGHT) : w ? 
    k.roundRect(0, r, this.size[0] / 2 + 1, n.NODE_TITLE_HEIGHT, [0, 0, 8, 8]) : k.roundRect(this.size[0] / 2, r, this.size[0] / 2 + 1, n.NODE_TITLE_HEIGHT, [0, 0, 8, 8]), m ? k.fill() : k.fillRect(0, r, this.size[0] + 1, n.NODE_TITLE_HEIGHT), k.textAlign = "center", k.font = "24px Arial", k.fillStyle = m ? "#DDD" : "#999", k.fillText("+", 0.25 * this.size[0], r + 24), k.fillText("+", 0.75 * this.size[0], r + 24));
  };
  w.prototype.onMouseDown = function(k, r, m) {
    k = this.size[1] - n.NODE_TITLE_HEIGHT + 0.5;
    console.log(0);
    r[1] > k && (r[0] < this.size[0] / 2 ? (console.log(1), m.showSubgraphPropertiesDialog(this)) : (console.log(2), m.showSubgraphPropertiesDialogRight(this)));
  };
  w.prototype.computeSize = function() {
    return [200, Math.max(this.inputs ? this.inputs.length : 0, this.outputs ? this.outputs.length : 0) * n.NODE_SLOT_HEIGHT + n.NODE_TITLE_HEIGHT];
  };
  w.prototype.onSubgraphTrigger = function(k, n) {
    k = this.findOutputSlot(k);
    -1 != k && this.triggerSlot(k);
  };
  w.prototype.onSubgraphNewInput = function(k, n) {
    -1 == this.findInputSlot(k) && this.addInput(k, n);
  };
  w.prototype.onSubgraphRenamedInput = function(k, n) {
    k = this.findInputSlot(k);
    -1 != k && (this.getInputInfo(k).name = n);
  };
  w.prototype.onSubgraphTypeChangeInput = function(k, n) {
    k = this.findInputSlot(k);
    -1 != k && (this.getInputInfo(k).type = n);
  };
  w.prototype.onSubgraphRemovedInput = function(k) {
    k = this.findInputSlot(k);
    -1 != k && this.removeInput(k);
  };
  w.prototype.onSubgraphNewOutput = function(k, n) {
    -1 == this.findOutputSlot(k) && this.addOutput(k, n);
  };
  w.prototype.onSubgraphRenamedOutput = function(k, n) {
    k = this.findOutputSlot(k);
    -1 != k && (this.getOutputInfo(k).name = n);
  };
  w.prototype.onSubgraphTypeChangeOutput = function(k, n) {
    k = this.findOutputSlot(k);
    -1 != k && (this.getOutputInfo(k).type = n);
  };
  w.prototype.onSubgraphRemovedOutput = function(k) {
    k = this.findInputSlot(k);
    -1 != k && this.removeOutput(k);
  };
  w.prototype.getExtraMenuOptions = function(k) {
    var n = this;
    return [{content:"Open", callback:function() {
      k.openSubgraph(n.subgraph);
    }}];
  };
  w.prototype.onResize = function(k) {
    k[1] += 20;
  };
  w.prototype.serialize = function() {
    var k = n.LGraphNode.prototype.serialize.call(this);
    k.subgraph = this.subgraph.serialize();
    return k;
  };
  w.prototype.clone = function() {
    var k = n.createNode(this.type), r = this.serialize();
    delete r.id;
    delete r.inputs;
    delete r.outputs;
    k.configure(r);
  ...
  w.prototype.buildFromNodes = function(k) {
    for (var n = {}, m = 0; m < k.length; ++m) {
      var r = k[m];
      n[r.id] = r;
    }
    for (m = 0; m < k.length; ++m) {
      r = k[m];
      if (r.inputs) {
        for (var x = 0; x < r.inputs.length; ++x) {
          var w = r.inputs[x];
          if (w && w.link) {
            var y = r.graph.links[w.link];
            y && (n[y.origin_id] || this.subgraph.addInput(w.name, y.type));
          }
        }
      }
      if (r.outputs) {
        for (x = 0; x < r.outputs.length; ++x) {
          if ((w = r.outputs[x]) && w.links && w.links.length) {
            for (var D = 0; D < w.links.length && (!(y = r.graph.links[w.links[D]]) || n[y.target_id]); ++D) {
            }
          }
        }
      }
  ...
  n.Subgraph = w;
  n.registerNodeType("graph/subgraph", w);
  k.title = "Input";
  k.desc = "Input of the graph";
  k.prototype.onConfigure = function() {
    this.updateType();
  };
  k.prototype.updateType = function() {
    var k = this.properties.type;
    this.type_widget.value = k;
    this.outputs[0].type != k && (n.isValidConnection(this.outputs[0].type, k) || this.disconnectOutput(0), this.outputs[0].type = k);
    "number" == k ? (this.value_widget.type = "number", this.value_widget.value = 0) : "boolean" == k ? (this.value_widget.type = "toggle", this.value_widget.value = !0) : "string" == k ? (this.value_widget.type = "text", this.value_widget.value = "") : (this.value_widget.type = null, this.value_widget.value = null);
    this.properties.value = this.value_widget.value;
    this.graph && this.name_in_graph && this.graph.changeInputType(this.name_in_graph, k);
  };
  k.prototype.onPropertyChanged = function(k, n) {
    if ("name" == k) {
      if ("" == n || n == this.name_in_graph || "enabled" == n) {
        return !1;
      }
      this.graph && (this.name_in_graph ? this.graph.renameInput(this.name_in_graph, n) : this.graph.addInput(n, this.properties.type));
      this.name_in_graph = this.name_widget.value = n;
    } else {
      "type" == k && this.updateType();
    }
  };
  k.prototype.getTitle = function() {
    return this.flags.collapsed ? this.properties.name : this.title;
  };
  k.prototype.onAction = function(k, r) {
    this.properties.type == n.EVENT && this.triggerSlot(0, r);
  };
  k.prototype.onExecute = function() {
    var k = this.graph.inputs[this.properties.name];
    k ? this.setOutputData(0, void 0 !== k.value ? k.value : this.properties.value) : this.setOutputData(0, this.properties.value);
  };
  k.prototype.onRemoved = function() {
    this.name_in_graph && this.graph.removeInput(this.name_in_graph);
  };
  n.GraphInput = k;
  n.registerNodeType("graph/input", k);
  y.title = "Output";
  y.desc = "Output of the graph";
  y.prototype.onPropertyChanged = function(k, n) {
    if ("name" == k) {
      if ("" == n || n == this.name_in_graph || "enabled" == n) {
        return !1;
      }
      this.graph && (this.name_in_graph ? this.graph.renameOutput(this.name_in_graph, n) : this.graph.addOutput(n, this.properties.type));
      this.name_in_graph = this.name_widget.value = n;
    } else {
      "type" == k && this.updateType();
    }
  ...
  y.prototype.updateType = function() {
    var k = this.properties.type;
    this.type_widget && (this.type_widget.value = k);
    if (this.inputs[0].type != k) {
      if ("action" == k || "event" == k) {
        k = n.EVENT;
      }
      n.isValidConnection(this.inputs[0].type, k) || this.disconnectInput(0);
      this.inputs[0].type = k;
    }
    this.graph && this.name_in_graph && this.graph.changeOutputType(this.name_in_graph, k);
  };
  y.prototype.onExecute = function() {
    this._value = this.getInputData(0);
    this.graph.setOutputData(this.properties.name, this._value);
  };
  y.prototype.onAction = function(k, r) {
    this.properties.type == n.ACTION && this.graph.trigger(this.properties.name, r);
  };
  ...
  n.GraphOutput = y;
  n.registerNodeType("graph/output", y);
})(this);
