...
(function(x) {
  ...
  h.prototype.drawNodeShape = function(a, b, d, f, g, c, k) {
    ...
    if (w || u == e.TRANSPARENT_TITLE) {
      ...
      !n && (b.font = this.title_text_font, k = String(a.getTitle())) && (b.shadowBlur = this.title_shadow_blur, b.shadowOffsetX = this.title_shadow_offset_x, b.shadowOffsetY = this.title_shadow_offset_y, b.shadowColor = this.title_shadow_color, b.fillStyle = c ? e.NODE_SELECTED_TITLE_COLOR : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(k), b.fillText(k.substr(0, 20), g, e.NODE_TITLE_TEXT_Y - g), b.textAlign = "left") : (b.textAlign = 
      "left", b.fillText(k, g, e.NODE_TITLE_TEXT_Y - g)));
  ...
  h.prototype.renderLink = function(a, b, d, f, g, c, k, m, q, u) {
    ...
    a.rotate(n), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(f[0], f[1]), a.rotate(u), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), this.render_link_center && (a.beginPath(), a.arc(g[0], g[1], 5, 0, 2 * Math.PI), a.fill()));
    if (c) {
